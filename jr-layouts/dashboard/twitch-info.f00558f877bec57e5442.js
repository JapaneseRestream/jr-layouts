...
/******/ 	deferredModules.push(["./src/dashboard/twitch-info.tsx","common~current-game~edit-modal~games-list~misc-controls~twitch-info"]);
...
const Container = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "twitch-info__Container",
  componentId: "sc-1ryogdq-0"
})(["display:flex;flex-flow:column nowrap;justify-content:flex-start;align-items:center;"]);
const InfoContainer = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({
  displayName: "twitch-info__InfoContainer",
  componentId: "sc-1ryogdq-1"
})(["width:100vw;display:flex;flex-flow:column nowrap;justify-content:flex-start;align-items:flex-start;"]);
...
/***/ "./src/use-nodecg/use-replicant.ts":
/*!*****************************************!*\
  !*** ./src/use-nodecg/use-replicant.ts ***!
  \*****************************************/
/*! exports provided: useReplicant */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useReplicant", function() { return useReplicant; });
...
const useReplicant = (replicant, initialValue) => {
  const [value, updateValue] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(initialValue);
  ...
  const changeHandler = newValue => {
    updateValue(oldValue => {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.isEqual(oldValue, newValue)) {
        return oldValue;
      }

      return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.clone(newValue);
    });
  };
...
/******/ });
//# sourceMappingURL=twitch-info.f00558f877bec57e5442.js.map